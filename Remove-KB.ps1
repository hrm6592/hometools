function Remove-KB {
    ...
    {
        # If the HotfixID property contains any text,
        ...
        # Wait for wusa.exe to finish and exit (wusa.exe actually
        # leverages TrustedInstaller.exe, so you won't see much
        # activity within the wusa process)
